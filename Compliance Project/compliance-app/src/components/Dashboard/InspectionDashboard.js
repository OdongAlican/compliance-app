...
const inspections = [
  { title: 'Canteen Inspection', formPath: '/form/canteen-inspection', image: '/canteen-inspection.png' },
  { title: 'Fuel Storage Tank Inspection Checklist', formPath: '/form/fuel-storage-tank-inspection', image: '/fuel-storage-tank-inspection.png' },
  { title: 'Hand and Power Tool Inspection Form', formPath: '/form/hand-and-power-tool-inspection', image: '/hand-and-power-tool-inspection.png' },
  { title: 'PPE Inspection Form', formPath: '/form/ppe-compliance', image: '/ppe-compliance.png' },
  { title: 'Science Laboratory Inspection Form', formPath: '/form/science-laboratory-inspection', image: '/science-laboratory-inspection.png' },
  { title: 'Swimming Pool Inspection Checklist', formPath: '/form/swimming-pool-inspection', image: '/swimming-pool-inspection.png' },
  { title: 'Vehicle Inspection Form', formPath: '/form/vehicle-inspection', image: '/vehicle-inspection.png' },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {inspections.map((item, idx) => (
          <div
            ...
            className="group flex flex-col justify-between h-full cursor-pointer p-6 rounded-lg border border-sky-100 hover:bg-primary hover:text-tertiary transition duration-200"
          >
            {/* Image + Text block */}
            ...
            <div className="flex justify-end mt-1">
              <svg
                className="w-5 h-5 text-gray-500 transition-transform duration-300 group-hover:-translate-y-4 group-hover:text-white"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="currentColor"
