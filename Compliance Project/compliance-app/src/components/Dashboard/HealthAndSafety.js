...
const inspections = [
  { title: 'Checklist', formPath: '/form/checklist', image: '/checklist.png' },
  { title: 'Workplace Inspection', formPath: '/form/workplace-inspection-report', image: '/workplace-inspection-report.png' },
  { title: 'Emergency Preparedness', formPath: '/form/emergency-preparedness', image: '/emergency-preparedness.png' },
  { title: 'PPE Compliance', formPath: '/form/ppe-compliance', image: '/ppe-compliance.png' },
  { title: 'Capa Tracking', formPath: '/form/capa-tracking', image: '/capa-tracking.png' },
  { title: 'Management Review Meeting', formPath: '/form/management-review-meeting', image: '/management-review-meeting.png' },
  { title: 'Recent Audit', formPath: '/form/training-competency', image: '/training-competency.png' },
];
...
export default function HealthAndSafetyDashboard() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6">Health and Safety</h1>
