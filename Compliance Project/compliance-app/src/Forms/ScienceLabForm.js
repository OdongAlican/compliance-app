...
function ScienceLabForm({ children, value, onChange, ...props }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative p-6">
        ...
        {currentSection === 1 && (
          <ScienceLabForm value="poolsafety">
            ...
            <ScienceLabForm value="water safety">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border">
      ...
      <div className="space-y-3">
        {[
          { label: "Science Area", status: "checked" },
          { label: "Lab Area", status: "checked" },
    ...
    <div className="bg-gray-50 p-6 rounded-lg shadow-sm border space-y-6">
      ...
      {/* Committee Chair */}
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-1">ScienceLab Committee Chair</label>
