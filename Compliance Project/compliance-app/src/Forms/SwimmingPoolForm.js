...
function SwimmingPoolForm({ children, value, onChange, ...props }) {
...
export default function SwimmingPoolFormModal({ isOpen, onClose, inspectionId }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative p-6">
        ...
        {currentSection === 1 && (
          <SwimmingPoolForm value="poolsafety">
            ...
            <SwimmingPoolForm value="water safety">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border">
      ...
      <div className="space-y-3">
        {[
          { label: "Pool Safety & Structure", status: "checked" },
          { label: "Water Quality And Maintenance", status: "checked" },
          { label: "Changing Rooms And Facilities", status: "checked" },
          { label: "Personnel Procedures", status: "checked" },
         { label: "Staff & Emmergency Readiness", status: "checked" },
    ...
    <div className="bg-gray-50 p-6 rounded-lg shadow-sm border space-y-6">
      ...
      {/* Committee Chair */}
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-1">SwimmingPool Committee Chair</label>
