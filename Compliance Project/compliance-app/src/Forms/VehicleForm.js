...
function VehicleForm({ children, value, onChange, ...props }) {
...
export default function VehicleFormModal({ isOpen, onClose, inspectionId }) {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border">
      ...
      <div className="space-y-3">
        {[
          { label: "Vehicle Inspection", status: "checked" },
          { label: "Vehicle Safety & Functionality", status: "checked" },
