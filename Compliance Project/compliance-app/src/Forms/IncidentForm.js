...
function IncidentForm({ children, value, onChange, ...props }) {
...
export default function IncidentFormModal({ isOpen, onClose, inspectionId }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative p-6">
        ...
        <h1 className="text-2xl font-bold text-center text-green-700 mb-2">
          INCIDENT MANAGEMENT INSPECTION FORM
        </h1>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border">
      ...
      <div className="space-y-3">
        {[
          ...
          { label: "Pipping And Connection", status: "checked" },
          { label: "Staff And Emmergency Readiness", status: "checked" },
    ...
    <div className="bg-gray-50 p-6 rounded-lg shadow-sm border space-y-6">
      ...
      {/* Committee Chair */}
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-1">Fuel Committee Chair</label>
