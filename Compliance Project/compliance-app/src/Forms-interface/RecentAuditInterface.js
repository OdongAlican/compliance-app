...
import RecentExecuteModal from "../components/Auditors-View/ChecklistExecute";
import CorrectiveActionFormModal from "../components/Action/CorrectiveActionForm";
import RecentAuditFormModal from "../Forms/RecentAuditForm";
import RecentCreateInspectionModal from "../components/Audit-Create/RecentCreateform";
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto bg-gray-50 min-h-screen">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Recent Audit</h1>
        <button
          onClick={() => {
