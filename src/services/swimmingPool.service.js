/**
 * swimmingPool.service.js
 * Full API service layer for the Swimming Pool Inspection module.
 *
 * Covers:
 *  - Swimming Pool Inspection Setup  (/swimming_pool_inspections)
 *  - Performed Swimming Pool Inspections (/perform_swimming_pool_inspections)
...
const BASE    = '/swimming_pool_inspections';
const PERFORM = '/perform_swimming_pool_inspections';

// ─────────────────────────────────────────────────────────────────────────────
// 1. SWIMMING POOL INSPECTION SETUP
// ─────────────────────────────────────────────────────────────────────────────
export const SwimmingPoolSetupService = {
  /**
   * GET /swimming_pool_inspections
   * Supports: page, per_page,
   *   filter[pool_type|pool_location|date_from|date_to|safety_officer_id|supervisor_id]
   */
  list: (params = {}) => api.get(BASE, { params }),

  /** GET /swimming_pool_inspections/:id */
  get: (id) => api.get(`${BASE}/${id}`),

  /**
   * POST /swimming_pool_inspections
   * Body: { swimming_pool_inspection: { name, pool_type, pool_location, location, date, time, note, safety_officer_id, supervisor_id, inspection_id } }
   */
  create: (data) => api.post(BASE, { swimming_pool_inspection: data }),

  /**
   * PUT /swimming_pool_inspections/:id
   */
  update: (id, data) => api.put(`${BASE}/${id}`, { swimming_pool_inspection: data }),

  /** DELETE /swimming_pool_inspections/:id */
  remove: (id) => api.delete(`${BASE}/${id}`),

  /** POST /swimming_pool_inspections/:id/reassign_supervisor  { supervisor_id } */
  reassignSupervisor: (id, supervisorId) =>
    api.post(`${BASE}/${id}/reassign_supervisor`, { supervisor_id: supervisorId }),

  /** POST /swimming_pool_inspections/:id/reassign_safety_officer  { safety_officer_id } */
  reassignSafetyOfficer: (id, safetyOfficerId) =>
    api.post(`${BASE}/${id}/reassign_safety_officer`, { safety_officer_id: safetyOfficerId }),
};

// ─────────────────────────────────────────────────────────────────────────────
// 2. PERFORMED SWIMMING POOL INSPECTIONS
// ─────────────────────────────────────────────────────────────────────────────
export const SwimmingPoolPerformService = {
  /**
   * GET /swimming_pool_inspections/:setupId/performs
  ...
  /** PUT /perform_swimming_pool_inspections/:id */
  update: (id, data) => api.put(`${PERFORM}/${id}`, { perform: data }),

  /** DELETE /perform_swimming_pool_inspections/:id */
  remove: (id) => api.delete(`${PERFORM}/${id}`),

  /**
   * POST /perform_swimming_pool_inspections/:id/sign_off
   * Body: { sign_off: { note } }
   */
  signOff: (id, note = '') =>
...
// ─────────────────────────────────────────────────────────────────────────────
export const SwimmingPoolChecklistService = {
  /** GET /perform_swimming_pool_inspections/:performId/checklists */
  list: (performId) => api.get(`${PERFORM}/${performId}/checklists`),

  /**
   * POST /perform_swimming_pool_inspections/:performId/checklists
  ...
  /** DELETE /perform_swimming_pool_inspections/:performId/checklists/:checklistId */
...
// 4. CHECKLIST ITEMS
// ─────────────────────────────────────────────────────────────────────────────
export const SwimmingPoolChecklistItemService = {
  /** GET /perform_swimming_pool_inspections/:performId/checklists/:checklistId/items */
  list: (performId, checklistId) =>
    api.get(`${PERFORM}/${performId}/checklists/${checklistId}/items`),

  /**
   * POST /perform_swimming_pool_inspections/:performId/checklists/:checklistId/items
...
// 5. INSPECTION ISSUES
// ─────────────────────────────────────────────────────────────────────────────
export const SwimmingPoolIssueService = {
  /**
   * GET /perform_swimming_pool_inspections/:performId/issues
  ...
  /**
   * POST /perform_swimming_pool_inspections/:performId/issues
  ...
  /** PUT /perform_swimming_pool_inspections/:performId/issues/:issueId */
  update: (performId, issueId, data) =>
    api.put(`${PERFORM}/${performId}/issues/${issueId}`, { issue: data }),

  /** DELETE /perform_swimming_pool_inspections/:performId/issues/:issueId */
...
// 6. ISSUE ATTACHMENTS
// ─────────────────────────────────────────────────────────────────────────────
export const SwimmingPoolAttachmentService = {
...
// ─────────────────────────────────────────────────────────────────────────────
export const SwimmingPoolRepairAttachmentService = {
  list: (performId, issueId) =>
