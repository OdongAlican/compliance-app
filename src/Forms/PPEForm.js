...
function PPEForm({ children, value, onChange, ...props }) {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border">
      ...
      <div className="space-y-3">
        {[
          { label: "PPE Inspection", status: "checked" },
    ...
    <div className="bg-gray-50 p-6 rounded-lg shadow-sm border space-y-6">
      ...
      {/* Committee Chair */}
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-1">PPE Committee Chair</label>
