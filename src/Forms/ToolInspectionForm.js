...
function ToolInspectionForm({ children, value, onChange, ...props }) {
...
export default function ToolInspectionFormModal({ isOpen, onClose, inspectionId }) {
  ...
  return (
    ...
    "Tool stored safely after inspection",
        ...
        {currentSection === 2 && (
          <ToolInspectionForm value="issues">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="bg-gray-50 p-6 rounded-lg shadow-sm border space-y-6">
      ...
      {/* Committee Chair */}
      <div>
        <label className="block text-sm font-medium text-gray-600 mb-1">Fuel-Storage Committee Chair</label>
