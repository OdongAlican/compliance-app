...
import EmergencyExecuteModal from "../components/Auditors-View/ChecklistExecute";
import CorrectiveActionFormModal from "../components/Action/CorrectiveActionForm";
import EmergencyFormModal from "../Forms/EmergencyForm";
import EmergencyCreateInspectionModal from "../components/Audit-Create/EmergencyCreateform";
...
export default function EmergencyInterface() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto ui-page">
      ...
      <EmergencyCreateInspectionModal
