/* ── Hand & Power Tools Inspection — shared primitive components ──────── */
            ...
            <div key={stepNum} className="flex items-center" style={{ flex: isLast ? "0 0 auto" : 1 }}>
              <div className="flex flex-col items-center gap-1.5">
                ...
                <span
                  ...
                  style={{
                    color: isActive ? "var(--accent)" : isCompleted ? "#3fb950" : "var(--text-muted)",
                  }}
                >
                  {label}
                </span>
              ...
              {!isLast && (
                <div
                  ...
                  style={{
                    background: isCompleted ? "#3fb950" : "var(--border)",
                  }}
                />
              )}
            </div>
