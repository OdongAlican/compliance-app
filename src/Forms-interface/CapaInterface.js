...
import CapaExecuteModal from "../components/Auditors-View/ChecklistExecute";
import CorrectiveActionFormModal from "../components/Action/CorrectiveActionForm";
import CapaFormModal from "../Forms/CapaForm";
import CapaCreateInspectionModal from "../components/Audit-Create/CapaCreateform";
    ...
    <div className="relative inline-block text-left">
      ...
      {open && (
        <div
          ...
          className="ui-menu absolute right-0 mt-2 w-56 z-50"
        >
          <button
            type="button"
            role="menuitem"
          ...
          <button
            ...
            className="ui-menu-item text-green-700"
          >
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto ui-page">
      <div className="flex items-center justify-between mb-6">
        <h1 className="ui-title">Capa Tracking</h1>
        <button
          onClick={() => {
