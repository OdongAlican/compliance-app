...
export default function AddAdminFormModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-lg rounded-xl shadow-lg p-6 relative">
        ...
        {/* Title */}
        <h2 className="text-xl font-semibold mb-6">Add Admin</h2>

        {/* SUCCESS SCREEN */}
        {showSuccess && (
          <div className="text-center py-10">
            <CheckCircleIcon className="w-16 h-16 text-green-500 mx-auto mb-4" />
            <h3 className="text-lg font-semibold mb-2">Admin Added Successfully</h3>
            <p className="text-gray-600 mb-6">
              The Admin has been added to the system.
            </p>
