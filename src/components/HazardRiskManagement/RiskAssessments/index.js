...
function DeleteConfirmModal({ open, assessment, onConfirm, onCancel, loading }) {
  if (!open) return null;
  return (
    <div
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>
              The risk assessment and all associated data will be permanently removed.
            </p>
          </div>
        </div>
        ...
        {assessment && (
          ...
          >
            ...
            <p className="text-sm font-bold" style={{ color: 'var(--danger)' }}>
              Assessment #{assessment.id} &mdash; {assessment.activity}
            </p>
            {assessment.location && (
              <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>
                {assessment.location}
