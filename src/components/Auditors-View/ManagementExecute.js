...
export default function ManagementExecuteModal({ inspection, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto relative">
        ...
        <div className="p-6">
          <h2 className="text-xl font-bold mb-2">General Information: {inspection.id || "N/A"}</h2>
          <p className="text-sm text-gray-500 mb-4">Status: {inspection.status || "N/A"}</p>

          {/* General Info */}
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mb-6">
            <div>
              <div className="text-xs text-gray-500">Auditors Area</div>
